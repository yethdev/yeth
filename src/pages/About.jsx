...
const SKILLS = {
  ...
  'Infrastructure': ['Linux', 'Docker', 'AWS', 'Terraform', 'Proxmox'],
...
const TIMELINE = [
  {
    ...
    desc: 'Used AI so much I half-forgot how to code. It builds a lot of it, it doesnt work, then i fix everything and make the frontend',
  },
  {
    period: '2025',
