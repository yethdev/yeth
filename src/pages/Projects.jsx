...
const PROJECTS = [
  ...
  },
  {
    ...
    sub: 'search',
    github: 'https://github.com/yethdev/Flight-Search',
  ...
  },
  {
    ...
    github: 'https://github.com/yethdev/movies-that-dont-waste-my-time',
    category: 'forks',
  },
  {
    name: 'portfolio',
    description: "the portfolio you are viewing right now, i've spent way too much time on this but i love it",
    tags: ['react', 'vite'],
    status: 'active',
    link: '/',
    github: 'https://github.com/yethdev',
    category: 'other',
  },
]
